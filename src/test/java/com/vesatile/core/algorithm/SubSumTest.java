...
public class SubSumTest extends AbstractRecordTimeTestCase {
	...
	public void testSubSum0() {
		Assert.assertEquals(11,
				execute(subSum, "subSum0", new Object[] { target }));
	}

	@Test
	public void testSubSum1() {
		Assert.assertEquals(11,
				execute(subSum, "subSum1", new Object[] { target }));
	}

	@Test
	public void testSubSum2() {
		Assert.assertEquals(11,
				execute(subSum, "subSum2", new Object[] { target }));
	}

	@Test
	public void testSubSum3() {
		Assert.assertEquals(11,
				execute(subSum, "subSum3", new Object[] { target }));
	}
}
